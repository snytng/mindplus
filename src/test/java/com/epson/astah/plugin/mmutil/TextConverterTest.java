...
import snytng.astah.plugin.mindplus.TextConverter;
...
public class TextConverterTest {
	...
	public void test_splitSentence() {
		...
		String output = "車は道を走る。" + System.lineSeparator() + "タイヤは車の一部だ。" + System.lineSeparator();
	...
	public void test_splitBL() {
		String input  = "車\r\nは\n道を走る\r\n\r\nタイヤは車の一部だ \r\n  \r\n	\r\n";
		String output = "車\nは\n道を走る" + System.lineSeparator() + "タイヤは車の一部だ" + System.lineSeparator();
	...
	public void test_splitSentenceAndCR() {
		String input  = "車は道を走る。\r\nタイヤは車の一部だ。\r\n\r\n";
		String output = "車は道を走る。" + System.lineSeparator() + System.lineSeparator() + "タイヤは車の一部だ。" + System.lineSeparator() + System.lineSeparator() + System.lineSeparator();
		String result = TextConverter.splitMaruAndCR(input);
		assertEquals(result, output);
	}

	@Test
	public void test_splitNoun() {
		String input  = "車は道を走る";
		String output = "車" + System.lineSeparator() + "道";
		String result = TextConverter.splitNoun(input);
		assertEquals(result, output);
	}
	...
	public void test_replaceMaru2CR() {
		String input  = "車。道を走る。";
		String output = "車"  + System.lineSeparator() + "道を走る"  + System.lineSeparator();
